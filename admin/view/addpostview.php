...
<textarea class="form-control" name="post_content" id="post_content" cols="30" rows="10"></textarea>
 ...
 <div class="form-group">
<label class="small mb-1" for="post_image">Upload Thumbnail</label><br>
<input name="post_image" class="py-4" id="post_image" type="file"/>
 </div>
...
<?php
while($category=mysqli_fetch_assoc($getP)){ ?>
...
<option value="0">Unpublished</option>
 ...
 <input type="submit" name="add_post" value="Add Post" class="form-control btn btn-block  btn-success">
